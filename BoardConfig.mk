...
TARGET_BOOTLOADER_BOARD_NAME := A66A
...
BOARD_CUSTOM_BOOTIMG_MK := device/evercoss/a66a/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/evercoss/a66a/recovery/etc/twrp.fstab
